...
const FACET_COLUMNS = {
  ...
  'breakdown-ips': 'cdn.originating_ip',
  ...
  'breakdown-script-name': 'cdn.script_name',
  ...
  'breakdown-body-size': 'response.body_size',
...
const FACET_ALIASES = {
  ...
  'breakdown-script-name': ['worker', 'script', 'cloudflare'],
  ...
  'breakdown-body-size': ['response size', 'body size', 'bytes', 'body_size', 'payload'],
