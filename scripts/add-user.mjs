...
const TABLES = ['delivery', 'delivery_errors', 'admin', 'backend', 'cdn_requests_combined', 'cdn_requests_v2', 'cdn_facet_minutes', 'releases', 'oncall_shifts', 'lambda_logs', 'optel_admin', 'user_shifts'];
