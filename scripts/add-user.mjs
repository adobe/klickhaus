...
const TABLES = ['delivery', 'delivery_errors', 'delivery_archive', 'admin', 'backend', 'misc_services', 'da', 'da_worker_logs', 'cdn_facet_minutes', 'releases', 'oncall_shifts', 'lambda_logs', 'lambda_facet_minutes', 'optel_admin', 'user_shifts', 'site_configs', 'profile_configs', 'org_configs', 'site_configs_resolved'];
